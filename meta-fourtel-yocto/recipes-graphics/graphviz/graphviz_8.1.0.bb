...
FILES_${PN} += " \
    /usr/lib/x86_64-linux-gnu/perl5/5.34/gv.so \
    /usr/lib/x86_64-linux-gnu/perl5/5.34/gv.pm \
    /usr/local/lib/python3.10/dist-packages/_gv.so \
    /usr/local/lib/python3.10/dist-packages/gv.py \
"
